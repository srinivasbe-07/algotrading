# SMC Build — Progress Tracker

> Reference: `SMC-BUILD-PLAN.md` | Source reference: `refrence.pine`
...
| 2     | Market Structure (BOS & CHoCH) | Not Started | `phase2-market-structure.pine`  |       |
...
| 7     | Alerts & Final Polish          | Not Started | `phase7-final-smc.pine`         |       |
...
- `Review` — code written, needs chart testing
- `Done` — tested and verified on chart
